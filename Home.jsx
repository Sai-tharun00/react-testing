...
const HeroSection = ({ onReportClick, userRole }) => (
...
const Home = () => {
    ...
    const handleReportClick = () => {
        ...
        // Additional actions like sending analytics can be added here
    };
    ...
    return (
        <div className="bg-gray-100 font-sans">
            ...
            <HeroSection onReportClick={handleReportClick} userRole={userRole} />
            <FeaturesSection />
            <CallToActionSection />
            <Footer />
        </div>
